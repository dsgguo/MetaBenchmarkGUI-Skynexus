...
with safe_import_context() as import_ctx:
    ...
    from metabci.brainda.datasets import Cho2017
...
class Dataset(BaseDataset):
    ...
    parameters = {
        ...
        'duration': [i for i in np.arange(0, 3, 0.5)],
        'subject': [i for i in range(1, 53)]  # 1 to 52
    }
    ...
    def get_data(self):
        ...
        if dataset.dataset_code == "cho2017":
