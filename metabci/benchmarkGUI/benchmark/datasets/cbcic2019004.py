...
with safe_import_context() as import_ctx:
    ...
    from metabci.brainda.datasets import CBCIC2019004
...
class Dataset(BaseDataset):
    ...
    parameters = {
        ...
        'duration': [i for i in np.arange(0, 4, 0.2)],
        'subject': [i for i in range(1, 7)]  # 1 to 7
    }
    ...
    def get_data(self):
        ...
        if dataset.dataset_code == "cbcic2019004":
