...
with safe_import_context() as import_ctx:
    ...
    from metabci.brainda.datasets import Zhou2016
...
class Dataset(BaseDataset):
    ...
    parameters = {
        ...
        'duration': [i for i in np.arange(0.2, 5, 0.2)],
        'subject': [i for i in range(1, 5)]
    }
    ...
    def get_data(self):
        ...
        X, y, meta = paradigm.get_data(
            ...
            n_jobs=8,#并行加载数据，加快处理速度 8
            verbose=False
        )
        # print("X nbytes:", X.nbytes)
        if dataset.dataset_code == "alexeeg":
