...
with safe_import_context() as import_ctx:
    ...
    from metabci.brainda.datasets import CBCIC2019001
...
class Dataset(BaseDataset):
    ...
    parameters = {
        ...
        'duration': [i for i in np.arange(1.5, 5.5, 0.5)],
        'subject': [i for i in range(1, 19)]  # 1 to 18
    }
    ...
    def get_data(self):
        ...
        if dataset.dataset_code == "cbcic2019001":
